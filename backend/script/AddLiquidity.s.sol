...
contract AddLiquidity is Script {
    ...
    PoolModifyLiquidityTest lpRouter = PoolModifyLiquidityTest(address(0xff80e212A63059B8d904104a7d58baa4fB00D30E));
    ...
    function run() external {
        ...
        vm.broadcast();
        lpRouter.modifyLiquidity(pool, IPoolManager.ModifyLiquidityParams(-600, 600, 100000, 0), hookData);
    }
}